...
<title>Biqticon | Orius Biotech | Soluciones para la producción agropecuaria sostenible</title>
...
<section>
	...
	<img src="images/biqticon.png">
	<h3>Para Madurar su cosecha y Recuperar su Caña Azúcar!</h3>
	<p>BIQTICON es un Fertilizante Orgánico Mineral formulado con nutrientes quelatados en aminoácidos de rápida asimilación y se usa en Caña de Azúcar para estimular la maduración mejorando la concentración de azucares. También se aplica en etapa vegetativa para recuperar los cultivos que se encuentran en condiciones difíciles de campo por intoxicaciones, daños por insectos plaga, daños por heladas o sequía y para estimular el buen desarrollo de tallos molinables. Esta autorizado para uso en Agricultura Ecológica y en Buenas Practicas Agrícolas.</p>


	<p><a href="">Comprar BIQTICON SC Litro</a></p>

	<p><strong>Documentos Técnicos</strong></p>
	<p><a href="" target="blank"><span class="icon-descarga"></span> BIQTICON SC - FICHA TECNICA</a></p>

	<p><strong>Respaldo (certificados)</strong></p>
	<p><a href="" target="blank"><span class="icon-descarga"></span> BIQTICON-BCS-AUTORIZACIÓN AGRORGANICA ES</a></p>

	<p><strong>Publicidad</strong></p>
	<p><a href="" target="blank"><span class="icon-descarga"></span> BIQTICON - CAÑA - FOLLETO</a></p>
